...
function App() {
  ...
  const adminUrl = `${import.meta.env.BASE_URL}legacy/admin.html?v=timing-active-v17`
  const homeUrl = `${import.meta.env.BASE_URL}legacy/index.html?v=timing-active-v17`
